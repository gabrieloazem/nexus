...
async function carregarRecursos(){
    ...
    for(let c1 = 0; c1 < registros.data.length; c1++){
        ...
        criar_elemento({
            id: idRegistro,
            tipo: 'div',
            classes: `f register w-100 hr-2 pt-05 mt-02 border-bottom-gray df-c-c texto-centralizado font-07 bg-${corFundo}`,
            destino: ['registros']
        })
        ...
        criar_elemento({
            ...
            classes: 'f w-15 h-100 texto-centralizado borda-none bg-transparent outline-none',
            valor: tipo,
            destino: [idRegistro],
        ...
        criar_elemento({
            tipo: 'select',
            opcoes: ['Crédito', 'Fixo', 'Mercado', 'Transporte', 'Reserva', 'Recursos'],
            classes: 'f w-15 h-100 texto-centralizado borda-none bg-transparent outline-none',
            valor: pagamento,
            destino: [idRegistro],
            onChange: async(event) => {
        ...
        criar_elemento({
            tipo: 'select',
            opcoes: ['Gabriel','Princess','Queti','Maria', 'Victor'],
            classes: 'f w-15 h-100 texto-centralizado borda-none bg-transparent outline-none',
            valor: destinatario,
            destino: [idRegistro],
            onChange: async(event) => {
        ...
        criar_elemento({
            tipo: 'input',
            classes: 'f w-15 h-100 borda-none bg-transparent outline-none',
            valor: descricao,
            destino: [idRegistro],
            onKeyUp: async(event) => {
                let valor = event.target.value
        ...
        criar_elemento({
            tipo: 'select',
            opcoes: ['Pendente', 'Emprestado', 'Pago','Devolvido'],
            classes: 'f w-15 h-100 texto-centralizado borda-none bg-transparent outline-none',
            valor: status,
            destino: [idRegistro],
            onChange: async(event) => {
    ...
    remover_elemento('g3c')
    elem('div',['id','g3c'],'', ['graficos'], 'f w-50 h-100 graphics')
    elem('canvas',['id','g3'],'', ['g3c'], 'f w-100 h-100')
    ...
    remover_elemento('g1c')
    elem('div',['id','g1c'],'', ['graficos'], 'f w-50 h-100 graphics')
    elem('canvas',['id','g1'],'', ['g1c'], 'f w-100 h-100')
