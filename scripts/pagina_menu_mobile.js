...
paginas['menu_mobile'] = {
    html: `
        <div class = 'register f w-90 pl-5 hr-3 mt-02 borda_padrao sombra_padrao borda-radius-10px df-c-e pointer font-09 cor-495057' onClick = "carregar_pagina({ nome: 'disciplinas' })" ) > Disciplinas </div>
        ...
        <div class = 'register f w-90 pl-5 hr-3 mt-02 borda_padrao sombra_padrao borda-radius-10px df-c-e pointer font-09 cor-495057' onClick = "carregar_pagina({ nome: 'fontes' })" ) > Fontes </div>
    `
}